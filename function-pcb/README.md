...
Each end of the flex cable should have the traces exposed on the same side. Here is the top and bottom of an example flex connector: ![flex cable](pictures/flexcable.jpg)
